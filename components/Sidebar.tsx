...
const navigation: NavigationItem[] = [
  ...
  { 
    ...
    icon: GlobeAltIcon,
    requiredPermission: 'read:global_fulfillment',
    subItems: [
      { name: '대시보드', href: '/global-fulfillment', icon: HomeIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '드롭시핑', href: '/global-fulfillment/drop-shipping', icon: CubeIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '상품 준비', href: '/global-fulfillment/preparation', icon: ClipboardDocumentCheckIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '파도 관리', href: '/global-fulfillment/wave-management', icon: ChartBarIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '2차 정렬', href: '/global-fulfillment/second-sorting', icon: TruckIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '검증/검사', href: '/global-fulfillment/inspection', icon: ClipboardDocumentCheckIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '패키지 검증', href: '/global-fulfillment/package-check', icon: CubeIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '무게 측정', href: '/global-fulfillment/weight-check', icon: ScaleIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '교환/반품', href: '/global-fulfillment/returns', icon: ArrowUpTrayIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '이상 처리', href: '/global-fulfillment/exceptions', icon: ExclamationTriangleIcon, requiredPermission: 'read:global_fulfillment' },
      { name: '마감 시간', href: '/global-fulfillment/cutoff', icon: ClockIcon, requiredPermission: 'read:global_fulfillment' },
    ]
  },
  { 
    name: '관리자', 
