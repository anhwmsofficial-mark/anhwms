...
BEGIN
  ...
  SELECT count(*) INTO v_org_count FROM public.org;
  IF v_org_count = 1 THEN
    SELECT id INTO v_default_org_id FROM public.org LIMIT 1;
  ELSE
...
IS 'tenant_id/org_id가 없더라도 본 데이터 변경을 막지 않도록 안전하게 감사 로그를 기록한다.';
